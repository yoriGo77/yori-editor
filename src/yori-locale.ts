...
export function richTableMenuStrings(lang: YoriUiLang) {
  ...
  return {
    ...
    insertRowAbove: pick(lang, { zh: "在上方插入行", en: "Insert row above" }),
    insertRowBelow: pick(lang, { zh: "在下方插入行", en: "Insert row below" }),
    deleteRow: pick(lang, { zh: "删除行", en: "Delete row" }),
    insertColumnLeft: pick(lang, { zh: "在左侧插入列", en: "Insert column left" }),
    insertColumnRight: pick(lang, { zh: "在右侧插入列", en: "Insert column right" }),
